...
const moduleMap = {'classnames':{get:()=>()=>__federation_import(new URL('__federation_shared_classnames-DNBU_3PZ.js', import.meta.url).href),import:true},'constate':{get:()=>()=>__federation_import(new URL('__federation_shared_constate-FJqBKorC.js', import.meta.url).href),import:true},'lodash':{get:()=>()=>__federation_import(new URL('__federation_shared_lodash-Cj4l3VQo.js', import.meta.url).href),import:true},'moment':{get:()=>()=>__federation_import(new URL('__federation_shared_moment-BAVSxgEa.js', import.meta.url).href),import:true},'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-C3qqueWT.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-DJkTNiiG.js', import.meta.url).href),import:true},'react-router-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-router-dom-B7WXsx5r.js', import.meta.url).href),import:true},'zvm-code-context':{get:()=>()=>__federation_import(new URL('__federation_shared_zvm-code-context-w6_YPIvc.js', import.meta.url).href),import:true}};
