const currentImports = {};
      ...
      let moduleMap = {
"./main":()=>{
      dynamicLoadingCss(["style-CLbg9otl.css"], false, './main');
      return __federation_import('./__federation_expose_Main-nJzWiZO9.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
